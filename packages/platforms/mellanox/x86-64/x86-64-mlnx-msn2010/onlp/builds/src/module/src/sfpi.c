...
static int
msn2010_sfp_node_read_int(char *node_path, int *value)
{
...
static char*
msn2010_sfp_get_port_path(int port, char *node_name)
{
...
static char*
msn2010_sfp_convert_i2c_path(int port, int devaddr)
{
...
onlp_sfpi_is_present(int port)
{
     ...
     */
    int present = -1;
    char* path = msn2010_sfp_get_port_path(port, "_status");

    if (msn2010_sfp_node_read_int(path, &present) != 0) {
...
{
    char* path = msn2010_sfp_get_port_path(port, "");
...
{
    char* path = msn2010_sfp_convert_i2c_path(port, devaddr);
    uint8_t data;
    int fd;
    int nrd;
